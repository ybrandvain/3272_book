...
```{r Tips02B, fig.cap='Intro to this chapter (2 min and 45 sec).', echo=FALSE, out.extra= 'allowfullscreen'}
...
```{r Tips02A, fig.cap='More about tidy data (3 min and 30 sec).', echo=FALSE, out.extra= 'allowfullscreen'}
